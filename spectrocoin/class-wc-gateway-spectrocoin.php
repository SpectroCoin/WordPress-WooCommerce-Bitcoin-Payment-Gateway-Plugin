...
class WC_Gateway_Spectrocoin extends WC_Payment_Gateway
{
	...
	public function __construct()
	{
		...
		$this->order_button_text  = __('Pay with SpectroCoin', 'spectrocoin');
		$this->method_title       = __('SpectroCoin', 'spectrocoin');
	...
	public function get_icon()
	{
		...
		$icon_html = '<img src="' . esc_attr($icon) . '" alt="' . esc_attr__('SpectroCoin logo', 'spectrocoin') . '" />';
...
<?php
	...
	public function init_form_fields()
	{
		$this->form_fields = array(
			'enabled' => array(
				'title' => __('Enable/Disable', 'spectrocoin'),
				'type' => 'checkbox',
				'label' => __('Enable SpectroCoin', 'spectrocoin'),
				'default' => 'yes'
			),
			'title' => array(
				'title' => __('Title', 'spectrocoin'),
				'type' => 'Text',
				'description' => __('This controls the title which the user sees during checkout.', 'spectrocoin'),
				'default' => __('Bitcoin', 'spectrocoin'),
				'desc_tip' => true,
			),
			'description' => array(
				'title' => __('Description', 'spectrocoin'),
				'type' => 'text',
				'desc_tip' => true,
				'description' => __('This controls the description which the user sees during checkout.', 'spectrocoin'),
				'default' => __('Pay via Bitcoin.', 'spectrocoin')
			),
			'merchant_id' => array(
				'title' => __('Merchant Id', 'spectrocoin'),
				'type' => 'text'
			),
			'project_id' => array(
				'title' => __('Project Id', 'spectrocoin'),
				'type' => 'text'
			),
			'private_key' => array(
				'title' => __('Private key', 'spectrocoin'),
				'type' => 'textarea',
				'description' => __('private key.', 'spectrocoin'),
				'default' => __('Please add your private key with (-----BEGIN PRIVATE KEY-----  -----END PRIVATE KEY-----) ', 'spectrocoin'),
				'desc_tip' => true,
			),
			'order_status' => array(
				'title' => __('Order status'),
				'desc_tip' => true,
				'description' => __('Order status after payment has been received.', 'spectrocoin'),
				'type' => 'select',
				'default' => 'completed',
				'options' => array(
					'pending' => __('pending', 'spectrocoin'),
					'processing' => __('processing', 'spectrocoin'),
					'completed' => __('completed', 'spectrocoin'),
				),
			),
	...
	public function process_payment($order_id)
	{
		...
		$order->update_status('on-hold', __('Waiting for SpectroCoin payment', 'spectrocoin'));
